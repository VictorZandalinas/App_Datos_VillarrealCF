...
class ReporteOfensivoCornersBilateral:
    ...
    def build_xg_by_player(self):
        """Construye diccionario de xG acumulado por jugador desde Opta (solo córners cerrados/In-swinger)."""
        xg_por_jugador = {}
    ...
    def create_reporte_grid(self):
        ...
        def draw_pattern(ax, scenarios, idx, data_source, side, img_balon):
            ...
            # Coordenadas Esquina
            if side == 'izquierda':
                xb, yb, xl, yl = 100, 100, 104, 102  # ¡xl=104 (fuera del campo)!
            else:
...
if __name__ == "__main__":
    ...
    if equipo:
        ...
        if fig:
            # Cambia 'cerrado' por 'cerrado' en el nombre del archivo
